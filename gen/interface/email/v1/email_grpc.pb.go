...
func (c *emailServiceClient) SendEmail(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedEmailServiceServer) SendEmail(context.Context, *Request) (*Response, error) {
...
func _EmailService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendEmail(ctx, req.(*Request))
	}
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "interface/email/v1/email.proto",
}
