...
type PaymentServiceClient interface {
	Charge(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *paymentServiceClient) Charge(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (c *paymentServiceClient) Refund(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
...
type PaymentServiceServer interface {
	Charge(context.Context, *Request) (*Response, error)
...
func (UnimplementedPaymentServiceServer) Charge(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Charge not implemented")
}
func (UnimplementedPaymentServiceServer) Refund(context.Context, *Request) (*Response, error) {
...
func _PaymentService_Charge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Charge(ctx, req.(*Request))
	}
...
func _PaymentService_Refund_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Refund(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "interface/payment/v1/payment.proto",
}
